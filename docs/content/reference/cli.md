...
```
spaceflightnews <command> [arguments] [flags]
```

Run `spaceflightnews <command> --help` for the full flag list on any command. This
...
per operation you declare in `spaceflightnews/domain.go`.
