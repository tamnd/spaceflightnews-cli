...
// HTTP behaviour is covered in spaceflightnews_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "spaceflightnews://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("spaceflightnews", "about")
	if err != nil || got.String() != "spaceflightnews://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want spaceflightnews://page/about", got.String(), err)
	}
}
